...
import static com.amazon.drs.drssampleandroidapp.Constants.DRS_ANDROID_NATIVE_OBJECT;

/**
 * Used to display the DRS device settings page.
 */
public class ChangeProductSelectionActivity extends Activity {

    private final static String TAG = ChangeProductSelectionActivity.class.getName();

    private WebView mWebView;
    private String mLwaAccessToken;

    @Override
    protected void onCreate(final Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_change_product_selection);
        final Intent intent = getIntent();
        if (intent != null) {
            final Bundle bundle = intent.getBundleExtra(BUNDLE_EXTRA);
            if (bundle != null) {
                mLwaAccessToken = bundle.getString(CUSTOMER_ACCESS_TOKEN);
            }
        }
        initializeWebView();
    }
    ...
    private void initializeWebView() {
        ...
        final WebAppInterface webAppInterface = new WebAppInterface(this, null);
        mWebView.addJavascriptInterface(webAppInterface, DRS_ANDROID_NATIVE_OBJECT);
        mWebView.loadUrl(appClient.getChangeProductSelectionPage(mLwaAccessToken));
    }
