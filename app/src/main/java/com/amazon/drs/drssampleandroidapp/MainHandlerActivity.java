...
/**
 * Creates a WebView and calls into the teaser page.
 */
public class MainHandlerActivity extends Activity {
    private final static String TAG = MainActivity.class.getName();
    private final static String DRS_ANDROID_NATIVE_OBJECT = "DrsAndroidNativeObject";
    private Bundle mFinalStageBundle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFinalStageBundle = intent.getBundleExtra(BUNDLE_EXTRA);
        initializeWebView();
    }
    ...
    private void initializeWebView() {
        ...
        final WebAppClient appClient = new WebAppClient();
        mWebView.setWebViewClient(appClient);
        final WebSettings webSettings = mWebView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        final WebAppInterface webAppInterface = new WebAppInterface(this, mFinalStageBundle);
        mWebView.addJavascriptInterface(webAppInterface, DRS_ANDROID_NATIVE_OBJECT);

        final String compositeId;
        if (mFinalStageBundle != null &&
                mFinalStageBundle.containsKey(COMPOSITE_ID_EXTRA)) {
            compositeId = mFinalStageBundle.getString(COMPOSITE_ID_EXTRA);
        } else {
            compositeId = COMPOSITE_IMAGE_ID;
        }
        mWebView.loadUrl(appClient.getTeaserPage(compositeId));
    }
    ...
    /**
     * Continue with login and open a MainActivity view.
     */
    public void openDrsDeviceView() {
        final Intent intent = new Intent(this, MainActivity.class);
        mWebView.post(new Runnable() {
            @Override
            public void run() {
                intent.putExtra(BUNDLE_EXTRA, mFinalStageBundle);
