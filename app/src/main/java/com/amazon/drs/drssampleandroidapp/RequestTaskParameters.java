...
import com.amazon.drs.drssampleandroidapp.CommunicationHandler.ApiCallType;

/**
 * Class used to pass values to Request Task .
 */
class RequestTaskParameters {

    final private String mHostName;
    final private String mHeaderKey;
    final private String mHeaderValue;
    final private ApiCallType mApiCallType;
     ...
     * @hide creates a request task.
     */
    RequestTaskParameters(final String hostName, final String headerKey,
                          final String headerValue, final ApiCallType apiCallType) {
        mHostName = hostName;
        mHeaderKey = headerKey;
        mHeaderValue = headerValue;
        mApiCallType = apiCallType;
    }

    /**
     * @return The host to which the connection is made.
     */
    String getHostName() {
        return mHostName;
    }
    ...
    /**
     * @return Header key for a post/put message.
     */
    String getHeaderKey() {
        return mHeaderKey;
    }
    ...
    /**
     * @return Header Value for a post/put message.
     */
