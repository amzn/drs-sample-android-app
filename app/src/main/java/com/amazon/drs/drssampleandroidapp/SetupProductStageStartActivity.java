...
/**
 * The first activity which shows the image of the device under consideration.
 */
public class SetupProductStageStartActivity extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setup_product_stage_start);
        initializeAlertDialog();
        initializeUI();
        // clear any existing shared preferences
        final SharedPreferences preferences = getSharedPreferences(MainActivity.USER_DETAILS,
                MODE_PRIVATE);
