...
/**
 * Interface to provide native android calls.
 */
class WebAppInterface {

    private final Context mContext;
    private final Bundle mFinalBundle;

    /**
     * Instantiate the interface and set the context.
     */
    WebAppInterface(final Context context, final Bundle bundle) {
        mContext = context;
        mFinalBundle = bundle;
    }
    ...
    @JavascriptInterface
    public void login() {
        ((MainHandlerActivity) mContext).openDrsDeviceView();
    }

    /**
     * Reset the app back to the beginning.
     */
    @JavascriptInterface
    public void restart() {
        Log.d("sampleApp", "restart");
        ((MainHandlerActivity) mContext).goBack();
    }

    /**
     * Performs the redirection back to the app.
     * Completes the activity invoking this object.
     */
    @JavascriptInterface
    public void exit() {
